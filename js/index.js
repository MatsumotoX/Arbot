  ...
  .then((data) => {
    ...
    .then((data) => {
      ...
      document.getElementById("KK-CO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountKK/buyBTC_KK_fee)- feeWD_BTC_KK ) * sellBTC_CO_fee) - (fundAmountKK * 1070.18)) / (fundAmountKK * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("KK-CO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyETH_KK_fee)- feeWD_ETH_KK ) * sellETH_CO_fee) - (fundAmountKK * 1070.18)) / (fundAmountKK * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("KK-CO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyXRP_KK_fee)- feeWD_XRP_KK ) * sellXRP_CO_fee) - (fundAmountKK * 1070.18)) / (fundAmountKK * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("KK-CO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyETC_KK_fee)- feeWD_ETC_KK ) * sellETC_CO_fee) - (fundAmountKK * 1070.18)) / (fundAmountKK * 1070.18)) * 100 ).toFixed(2);  

      document.getElementById("KK-CO_LTC_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyLTC_KK_fee)- feeWD_LTC_KK ) * sellLTC_CO_fee) - (fundAmountKK * 1070.18)) / (fundAmountKK * 1070.18)) * 100 ).toFixed(2);           
      ...
      // //KK-BX                        
       ...
       document.getElementById("KK-BX_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountKK/buyBTC_KK_fee)- feeWD_BTC_KK ) * sellBTC_BX_fee) - (fundAmountKK * 31.22)) / (fundAmountKK * 31.22)) * 100 ).toFixed(2);           

       document.getElementById("KK-BX_ETH_oneWay").innerHTML= 

                   ((((((fundAmountKK/buyETH_KK_fee)- feeWD_ETH_KK ) * sellETH_BX_fee) - (fundAmountKK * 31.22)) / (fundAmountKK * 31.22)) * 100 ).toFixed(2);           

       document.getElementById("KK-BX_XRP_oneWay").innerHTML= 

                   ((((((fundAmountKK/buyXRP_KK_fee)- feeWD_XRP_KK ) * sellXRP_BX_fee) - (fundAmountKK * 31.22)) / (fundAmountKK * 31.22)) * 100 ).toFixed(2); 

        document.getElementById("KK-BX_LTC_oneWay").innerHTML= 

                   ((((((fundAmountKK/buyLTC_KK_fee)- feeWD_LTC_KK ) * sellLTC_BX_fee) - (fundAmountKK * 31.22)) / (fundAmountKK * 31.22)) * 100 ).toFixed(2);           
...
//KK-KB
      ...
      document.getElementById("KK-KB_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountKK/buyBTC_KK_fee)- feeWD_BTC_KK ) * sellBTC_KB_fee) - (fundAmountKK * 1070.18)) / (fundAmountKK * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("KK-KB_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyETH_KK_fee)- feeWD_ETH_KK ) * sellETH_KB_fee) - (fundAmountKK * 1070.18)) / (fundAmountKK * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("KK-KB_XRP_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyXRP_KK_fee)- feeWD_XRP_KK ) * sellXRP_KB_fee) - (fundAmountKK * 1070.18)) / (fundAmountKK * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("KK-KB_ETC_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyETC_KK_fee)- feeWD_ETC_KK ) * sellETC_KB_fee) - (fundAmountKK * 1070.18)) / (fundAmountKK * 1070.18)) * 100 ).toFixed(2);  
      ...
      document.getElementById("CO-KK_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_KK_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-KK_ETH_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_KK_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-KK_XRP_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_KK_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-KK_ETC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETC_CO_fee)- feeWD_ETC_CO ) * sellETC_KK_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-KK_LTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyLTC_CO_fee)- feeWD_LTC_CO ) * sellLTC_KK_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           
      ...
      document.getElementById("CO-PO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_PO_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-PO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_PO_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-PO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_PO_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-PO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETC_CO_fee)- feeWD_ETC_CO ) * sellETC_PO_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);     

      document.getElementById("CO-PO_LTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyLTC_CO_fee)- feeWD_LTC_CO ) * sellLTC_PO_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      // //CO-BX                       

       document.getElementById("CO-BX_BTC_oneWay").innerHTML= 

                   ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_BX_fee) - (fundAmountCO / 33.75 )) / (fundAmountCO / 33.75 )) * 100 ).toFixed(2);           

       document.getElementById("CO-BX_ETH_oneWay").innerHTML= 

                   ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_BX_fee) - (fundAmountCO / 33.75 )) / (fundAmountCO / 33.75 )) * 100 ).toFixed(2);           

      document.getElementById("CO-BX_XRP_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_BX_fee) - (fundAmountCO / 33.75 )) / (fundAmountCO / 33.75 )) * 100 ).toFixed(2);  

      document.getElementById("CO-BX_LTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyLTC_CO_fee)- feeWD_LTC_CO ) * sellLTC_BX_fee) - (fundAmountCO / 33.75 )) / (fundAmountCO / 33.75 )) * 100 ).toFixed(2);           
      ...
      document.getElementById("CO-BF_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_BF_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-BF_ETH_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_BF_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-BF_XRP_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_BF_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-BF_ETC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETC_CO_fee)- feeWD_ETC_CO ) * sellETC_BF_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);   

      document.getElementById("CO-BF_LTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyLTC_CO_fee)- feeWD_LTC_CO ) * sellLTC_BF_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      //  //CO-BT                        

      document.getElementById("CO-BT_BTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_BT_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-BT_ETH_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_BT_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-BT_XRP_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_BT_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-BT_ETC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETC_CO_fee)- feeWD_ETC_CO ) * sellETC_BT_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2); 

      document.getElementById("CO-BT_LTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyLTC_CO_fee)- feeWD_LTC_CO ) * sellLTC_BT_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      //  //CO-BS                        

      document.getElementById("CO-BS_BTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_BS_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-BS_ETH_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_BS_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-BS_XRP_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_BS_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);       

      document.getElementById("CO-BS_LTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyLTC_CO_fee)- feeWD_LTC_CO ) * sellLTC_BS_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

       //CO-HB                        

      // document.getElementById("CO-HB_BTC_oneWay").innerHTML= 

      //             ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_HB_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("CO-HB_ETH_oneWay").innerHTML= 

      //             ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_HB_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("CO-HB_XRP_oneWay").innerHTML= 

      //             ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_HB_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("CO-HB_ETC_oneWay").innerHTML= 

      //             ((((((fundAmountCO/buyETC_CO_fee)- feeWD_ETC_CO ) * sellETC_HB_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);       

      // document.getElementById("CO-HB_LTC_oneWay").innerHTML= 

      //             ((((((fundAmountCO/buyLTC_CO_fee)- feeWD_LTC_CO ) * sellLTC_HB_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

        //CO-BN                        

      document.getElementById("CO-BN_BTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_BN_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-BN_ETH_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_BN_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("CO-BN_XRP_oneWay").innerHTML= 

      //             ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_BN_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("CO-BN_ETC_oneWay").innerHTML= 

      //             ((((((fundAmountCO/buyETC_CO_fee)- feeWD_ETC_CO ) * sellETC_BN_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);       

      document.getElementById("CO-BN_LTC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyLTC_CO_fee)- feeWD_LTC_CO ) * sellLTC_BN_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           
 ...
 //CO-QN                        
      ...
      document.getElementById("CO-QN_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_QN_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("CO-QN_ETH_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_QN_fee) - (fundAmountCO * 0.00093442224)) / (fundAmountCO * 0.00093442224)) * 100 ).toFixed(2);           
...
//CO-KB
      ...
      document.getElementById("PO-CO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountPO/buyBTC_PO_fee)- feeWD_BTC_PO ) * sellBTC_CO_fee) - (fundAmountPO * 1070.18)) / (fundAmountPO * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("PO-CO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyETH_PO_fee)- feeWD_ETH_PO ) * sellETH_CO_fee) - (fundAmountPO * 1070.18)) / (fundAmountPO * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("PO-CO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyXRP_PO_fee)- feeWD_XRP_PO ) * sellXRP_CO_fee) - (fundAmountPO * 1070.18)) / (fundAmountPO * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("PO-CO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyETC_PO_fee)- feeWD_ETC_PO ) * sellETC_CO_fee) - (fundAmountPO * 1070.18)) / (fundAmountPO * 1070.18)) * 100 ).toFixed(2);   

      document.getElementById("PO-CO_LTC_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyLTC_PO_fee)- feeWD_LTC_PO ) * sellLTC_CO_fee) - (fundAmountPO * 1070.18)) / (fundAmountPO * 1070.18)) * 100 ).toFixed(2);           

                  // //PO-BX                        

       document.getElementById("PO-BX_BTC_oneWay").innerHTML= 

                 ((((((fundAmountPO/buyBTC_PO_fee)- feeWD_BTC_PO ) * sellBTC_BX_fee) - (fundAmountPO * 31.22)) / (fundAmountPO * 31.22)) * 100 ).toFixed(2);           

      document.getElementById("PO-BX_ETH_oneWay").innerHTML= 

                   ((((((fundAmountPO/buyETH_PO_fee)- feeWD_ETH_PO ) * sellETH_BX_fee) - (fundAmountPO * 31.22)) / (fundAmountPO * 31.22)) * 100 ).toFixed(2);           

      document.getElementById("PO-BX_XRP_oneWay").innerHTML= 

                   ((((((fundAmountPO/buyXRP_PO_fee)- feeWD_XRP_PO ) * sellXRP_BX_fee) - (fundAmountPO * 31.22)) / (fundAmountPO * 31.22)) * 100 ).toFixed(2);  

      document.getElementById("PO-BX_LTC_oneWay").innerHTML= 

                   ((((((fundAmountPO/buyLTC_PO_fee)- feeWD_LTC_PO ) * sellLTC_BX_fee) - (fundAmountPO * 31.22)) / (fundAmountPO * 31.22)) * 100 ).toFixed(2);        
 //PO-BF                       
...
//PO-QN                       
  ...
  //  //PO-KB                        
      ...
      document.getElementById("PO-KB_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountPO/buyBTC_PO_fee)- feeWD_BTC_PO ) * sellBTC_KB_fee) - (fundAmountPO * 1070.18)) / (fundAmountPO * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("PO-KB_ETH_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyETH_PO_fee)- feeWD_ETH_PO ) * sellETH_KB_fee) - (fundAmountPO * 1070.18)) / (fundAmountPO * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("PO-KB_XRP_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyXRP_PO_fee)- feeWD_XRP_PO ) * sellXRP_KB_fee) - (fundAmountPO * 1070.18)) / (fundAmountPO * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("PO-KB_ETC_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyETC_PO_fee)- feeWD_ETC_PO ) * sellETC_KB_fee) - (fundAmountPO * 1070.18)) / (fundAmountPO * 1070.18)) * 100 ).toFixed(2);   
      ...
      // // //BX-KK                        
       ...
       document.getElementById("BX-KK_BTC_oneWay").innerHTML= 
                   ...
                   ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_KK_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-KK_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_KK_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-KK_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyXRP_BX_fee)- feeWD_XRP_BX ) * sellXRP_KK_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);  

        document.getElementById("BX-KK_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyLTC_BX_fee)- feeWD_LTC_BX ) * sellLTC_KK_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);         
      ...
      //BX-CO  
       ...
       document.getElementById("BX-CO_BTC_oneWay").innerHTML= 
                   ...
                   ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_CO_fee) - (fundAmountBX * 33.75 )) / (fundAmountBX * 33.75 )) * 100 ).toFixed(2);           

       document.getElementById("BX-CO_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_CO_fee) - (fundAmountBX * 33.75 )) / (fundAmountBX * 33.75 )) * 100 ).toFixed(2);           

       document.getElementById("BX-CO_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyXRP_BX_fee)- feeWD_XRP_BX ) * sellXRP_CO_fee) - (fundAmountBX * 33.75 )) / (fundAmountBX * 33.75 )) * 100 ).toFixed(2); 

        document.getElementById("BX-CO_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyLTC_BX_fee)- feeWD_LTC_BX ) * sellLTC_CO_fee) - (fundAmountBX * 33.75 )) / (fundAmountBX * 33.75 )) * 100 ).toFixed(2);           

      //BX-PO

       document.getElementById("BX-PO_BTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_PO_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-PO_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_PO_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-PO_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyXRP_BX_fee)- feeWD_XRP_BX ) * sellXRP_PO_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2); 

      document.getElementById("BX-PO_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyLTC_BX_fee)- feeWD_LTC_BX ) * sellLTC_PO_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);          

        //BX-BF

       document.getElementById("BX-BF_BTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_BF_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-BF_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_BF_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-BF_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyXRP_BX_fee)- feeWD_XRP_BX ) * sellXRP_BF_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);

        document.getElementById("BX-BF_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyLTC_BX_fee)- feeWD_LTC_BX ) * sellLTC_BF_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

      //BX-BT
  
       document.getElementById("BX-BT_BTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_BT_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-BT_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_BT_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-BT_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyXRP_BX_fee)- feeWD_XRP_BX ) * sellXRP_BT_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2); 

      document.getElementById("BX-BT_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyLTC_BX_fee)- feeWD_LTC_BX ) * sellLTC_BT_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2); 

      //BX-BS

       document.getElementById("BX-BS_BTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_BS_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-BS_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_BS_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-BS_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyXRP_BX_fee)- feeWD_XRP_BX ) * sellXRP_BS_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);  

        document.getElementById("BX-BS_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyLTC_BX_fee)- feeWD_LTC_BX ) * sellLTC_BS_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);         
      
      //BX-HB

       // document.getElementById("BX-HB_BTC_oneWay").innerHTML= 

       //             ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_HB_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       // document.getElementById("BX-HB_ETH_oneWay").innerHTML= 

       //             ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_HB_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       // document.getElementById("BX-HB_XRP_oneWay").innerHTML= 

       //             ((((((fundAmountBX/buyXRP_BX_fee)- feeWD_XRP_BX ) * sellXRP_HB_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           
      
      //BX-BN

       document.getElementById("BX-BN_BTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_BN_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-BN_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_BN_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);  

      document.getElementById("BX-BN_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyLTC_BX_fee)- feeWD_LTC_BX ) * sellLTC_BN_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

/*       document.getElementById("BX-BN_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyXRP_BX_fee)- feeWD_XRP_BX ) * sellXRP_BN_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           
*/     
//BX-QN

       document.getElementById("BX-QN_BTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_QN_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BX-QN_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_QN_fee) - (fundAmountBX / 31.22)) / (fundAmountBX / 31.22)) * 100 ).toFixed(2);  
  //BX-KB  

       document.getElementById("BX-KB_BTC_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyBTC_BX_fee)- feeWD_BTC_BX ) * sellBTC_KB_fee) - (fundAmountBX * 33.75 )) / (fundAmountBX * 33.75 )) * 100 ).toFixed(2);           

       document.getElementById("BX-KB_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyETH_BX_fee)- feeWD_ETH_BX ) * sellETH_KB_fee) - (fundAmountBX * 33.75 )) / (fundAmountBX * 33.75 )) * 100 ).toFixed(2);           

       document.getElementById("BX-KB_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBX/buyXRP_BX_fee)- feeWD_XRP_BX ) * sellXRP_KB_fee) - (fundAmountBX * 33.75 )) / (fundAmountBX * 33.75 )) * 100 ).toFixed(2); 
      ...
      document.getElementById("BF-CO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountBF/buyBTC_BF_fee)- feeWD_BTC_BF ) * sellBTC_CO_fee) - (fundAmountBF * 1070.18)) / (fundAmountBF * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BF-CO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountBF/buyETH_BF_fee)- feeWD_ETH_BF ) * sellETH_CO_fee) - (fundAmountBF * 1070.18)) / (fundAmountBF * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BF-CO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountBF/buyXRP_BF_fee)- feeWD_XRP_BF ) * sellXRP_CO_fee) - (fundAmountBF * 1070.18)) / (fundAmountBF * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BF-CO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountBF/buyETC_BF_fee)- feeWD_ETC_BF ) * sellETC_CO_fee) - (fundAmountBF * 1070.18)) / (fundAmountBF * 1070.18)) * 100 ).toFixed(2);   

      document.getElementById("BF-CO_LTC_oneWay").innerHTML= 

                  ((((((fundAmountBF/buyLTC_BF_fee)- feeWD_LTC_BF ) * sellLTC_CO_fee) - (fundAmountBF * 1070.18)) / (fundAmountBF * 1070.18)) * 100 ).toFixed(2);           
      ...
      document.getElementById("BF-PO_LTC_oneWay").innerHTML= 
       ...
       document.getElementById("BF-BX_BTC_oneWay").innerHTML= 
                 ...
                 ((((((fundAmountBF/buyBTC_BF_fee)- feeWD_BTC_BF ) * sellBTC_BX_fee) - (fundAmountBF * 31.22)) / (fundAmountBF * 31.22)) * 100 ).toFixed(2);           

      document.getElementById("BF-BX_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBF/buyETH_BF_fee)- feeWD_ETH_BF ) * sellETH_BX_fee) - (fundAmountBF * 31.22)) / (fundAmountBF * 31.22)) * 100 ).toFixed(2);           

      document.getElementById("BF-BX_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBF/buyXRP_BF_fee)- feeWD_XRP_BF ) * sellXRP_BX_fee) - (fundAmountBF * 31.22)) / (fundAmountBF * 31.22)) * 100 ).toFixed(2); 

       document.getElementById("BF-BX_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBF/buyLTC_BF_fee)- feeWD_LTC_BF ) * sellLTC_BX_fee) - (fundAmountBF * 31.22)) / (fundAmountBF * 31.22)) * 100 ).toFixed(2);            
...
//BF-KB                        
      ...
      document.getElementById("BF-KB_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountBF/buyBTC_BF_fee)- feeWD_BTC_BF ) * sellBTC_KB_fee) - (fundAmountBF * 1070.18)) / (fundAmountBF * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BF-KB_ETH_oneWay").innerHTML= 

                  ((((((fundAmountBF/buyETH_BF_fee)- feeWD_ETH_BF ) * sellETH_KB_fee) - (fundAmountBF * 1070.18)) / (fundAmountBF * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BF-KB_XRP_oneWay").innerHTML= 

                  ((((((fundAmountBF/buyXRP_BF_fee)- feeWD_XRP_BF ) * sellXRP_KB_fee) - (fundAmountBF * 1070.18)) / (fundAmountBF * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BF-KB_ETC_oneWay").innerHTML= 

                  ((((((fundAmountBF/buyETC_BF_fee)- feeWD_ETC_BF ) * sellETC_KB_fee) - (fundAmountBF * 1070.18)) / (fundAmountBF * 1070.18)) * 100 ).toFixed(2);   
      ...
      document.getElementById("BT-CO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountBT/buyBTC_BT_fee)- feeWD_BTC_BT ) * sellBTC_CO_fee) - (fundAmountBT * 1070.18)) / (fundAmountBT * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BT-CO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountBT/buyETH_BT_fee)- feeWD_ETH_BT ) * sellETH_CO_fee) - (fundAmountBT * 1070.18)) / (fundAmountBT * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BT-CO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountBT/buyXRP_BT_fee)- feeWD_XRP_BT ) * sellXRP_CO_fee) - (fundAmountBT * 1070.18)) / (fundAmountBT * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BT-CO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountBT/buyETC_BT_fee)- feeWD_ETC_BT ) * sellETC_CO_fee) - (fundAmountBT * 1070.18)) / (fundAmountBT * 1070.18)) * 100 ).toFixed(2); 

      document.getElementById("BT-CO_LTC_oneWay").innerHTML= 

                  ((((((fundAmountBT/buyLTC_BT_fee)- feeWD_LTC_BT ) * sellLTC_CO_fee) - (fundAmountBT * 1070.18)) / (fundAmountBT * 1070.18)) * 100 ).toFixed(2);           
      ...
      document.getElementById("BT-PO_LTC_oneWay").innerHTML= 
       ...
       document.getElementById("BT-BX_BTC_oneWay").innerHTML= 
                 ...
                 ((((((fundAmountBT/buyBTC_BT_fee)- feeWD_BTC_BT ) * sellBTC_BX_fee) - (fundAmountBT * 31.22)) / (fundAmountBT * 31.22)) * 100 ).toFixed(2);           

      document.getElementById("BT-BX_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBT/buyETH_BT_fee)- feeWD_ETH_BT ) * sellETH_BX_fee) - (fundAmountBT * 31.22)) / (fundAmountBT * 31.22)) * 100 ).toFixed(2);           

      document.getElementById("BT-BX_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBT/buyXRP_BT_fee)- feeWD_XRP_BT ) * sellXRP_BX_fee) - (fundAmountBT * 31.22)) / (fundAmountBT * 31.22)) * 100 ).toFixed(2);  

      document.getElementById("BT-BX_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBT/buyLTC_BT_fee)- feeWD_LTC_BT ) * sellLTC_BX_fee) - (fundAmountBT * 31.22)) / (fundAmountBT * 31.22)) * 100 ).toFixed(2);         
...
*/
    ...
    ///BT-BN                       
      ...
      document.getElementById("BT-KB_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountBT/buyBTC_BT_fee)- feeWD_BTC_BT ) * sellBTC_KB_fee) - (fundAmountBT * 1070.18)) / (fundAmountBT * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BT-KB_ETH_oneWay").innerHTML= 

                  ((((((fundAmountBT/buyETH_BT_fee)- feeWD_ETH_BT ) * sellETH_KB_fee) - (fundAmountBT * 1070.18)) / (fundAmountBT * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BT-KB_XRP_oneWay").innerHTML= 

                  ((((((fundAmountBT/buyXRP_BT_fee)- feeWD_XRP_BT ) * sellXRP_KB_fee) - (fundAmountBT * 1070.18)) / (fundAmountBT * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BT-KB_ETC_oneWay").innerHTML= 

                  ((((((fundAmountBT/buyETC_BT_fee)- feeWD_ETC_BT ) * sellETC_KB_fee) - (fundAmountBT * 1070.18)) / (fundAmountBT * 1070.18)) * 100 ).toFixed(2); 
     ...
     //BS-KK                        
      ...
      document.getElementById("BS-CO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountBS/buyBTC_BS_fee)- feeWD_BTC_BS ) * sellBTC_CO_fee) - (fundAmountBS * 1070.18)) / (fundAmountBS * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BS-CO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountBS/buyETH_BS_fee)- feeWD_ETH_BS ) * sellETH_CO_fee) - (fundAmountBS * 1070.18)) / (fundAmountBS * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BS-CO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountBS/buyXRP_BS_fee)- feeWD_XRP_BS ) * sellXRP_CO_fee) - (fundAmountBS * 1070.18)) / (fundAmountBS * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BS-CO_LTC_oneWay").innerHTML= 

                  ((((((fundAmountBS/buyLTC_BS_fee)- feeWD_LTC_BS ) * sellLTC_CO_fee) - (fundAmountBS * 1070.18)) / (fundAmountBS * 1070.18)) * 100 ).toFixed(2);           
      ...
      document.getElementById("BS-BX_BTC_oneWay").innerHTML= 
                 ...
                 ((((((fundAmountBS/buyBTC_BS_fee)- feeWD_BTC_BS ) * sellBTC_BX_fee) - (fundAmountBS * 31.22)) / (fundAmountBS * 31.22)) * 100 ).toFixed(2);           

      document.getElementById("BS-BX_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBS/buyETH_BS_fee)- feeWD_ETH_BS ) * sellETH_BX_fee) - (fundAmountBS * 31.22)) / (fundAmountBS * 31.22)) * 100 ).toFixed(2);           

      document.getElementById("BS-BX_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBS/buyXRP_BS_fee)- feeWD_XRP_BS ) * sellXRP_BX_fee) - (fundAmountBS * 31.22)) / (fundAmountBS * 31.22)) * 100 ).toFixed(2); 

      document.getElementById("BS-BX_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBS/buyLTC_BS_fee)- feeWD_LTC_BS ) * sellLTC_BX_fee) - (fundAmountBS * 31.22)) / (fundAmountBS * 31.22)) * 100 ).toFixed(2);          
...
//BS-KB                        
      ...
      document.getElementById("BS-KB_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountBS/buyBTC_BS_fee)- feeWD_BTC_BS ) * sellBTC_KB_fee) - (fundAmountBS * 1070.18)) / (fundAmountBS * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BS-KB_ETH_oneWay").innerHTML= 

                  ((((((fundAmountBS/buyETH_BS_fee)- feeWD_ETH_BS ) * sellETH_KB_fee) - (fundAmountBS * 1070.18)) / (fundAmountBS * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BS-KB_XRP_oneWay").innerHTML= 

                  ((((((fundAmountBS/buyXRP_BS_fee)- feeWD_XRP_BS ) * sellXRP_KB_fee) - (fundAmountBS * 1070.18)) / (fundAmountBS * 1070.18)) * 100 ).toFixed(2);           
      ...
      //             ((((((fundAmountHB/buyBTC_HB_fee)- feeWD_BTC_HB ) * sellBTC_CO_fee) - (fundAmountHB * 1070.18)) / (fundAmountHB * 1070.18)) * 100 ).toFixed(2);           

      // document.getElementById("HB-CO_ETH_oneWay").innerHTML= 

      //             ((((((fundAmountHB/buyETH_HB_fee)- feeWD_ETH_HB ) * sellETH_CO_fee) - (fundAmountHB * 1070.18)) / (fundAmountHB * 1070.18)) * 100 ).toFixed(2);           

      // document.getElementById("HB-CO_XRP_oneWay").innerHTML= 

      //             ((((((fundAmountHB/buyXRP_HB_fee)- feeWD_XRP_HB ) * sellXRP_CO_fee) - (fundAmountHB * 1070.18)) / (fundAmountHB * 1070.18)) * 100 ).toFixed(2);           

      // document.getElementById("HB-CO_ETC_oneWay").innerHTML= 

      //             ((((((fundAmountHB/buyETC_HB_fee)- feeWD_ETC_HB ) * sellETC_CO_fee) - (fundAmountHB * 1070.18)) / (fundAmountHB * 1070.18)) * 100 ).toFixed(2);           

      // document.getElementById("HB-CO_LTC_oneWay").innerHTML= 

      //             ((((((fundAmountHB/buyLTC_HB_fee)- feeWD_LTC_HB ) * sellLTC_CO_fee) - (fundAmountHB * 1070.18)) / (fundAmountHB * 1070.18)) * 100 ).toFixed(2);           
      ...
      //            ((((((fundAmountHB/buyBTC_HB_fee)- feeWD_BTC_HB ) * sellBTC_BX_fee) - (fundAmountHB * 31.22)) / (fundAmountHB * 31.22)) * 100 ).toFixed(2);           

      // document.getElementById("HB-BX_ETH_oneWay").innerHTML= 

      //              ((((((fundAmountHB/buyETH_HB_fee)- feeWD_ETH_HB ) * sellETH_BX_fee) - (fundAmountHB * 31.22)) / (fundAmountHB * 31.22)) * 100 ).toFixed(2);           

      // document.getElementById("HB-BX_XRP_oneWay").innerHTML= 

      //              ((((((fundAmountHB/buyXRP_HB_fee)- feeWD_XRP_HB ) * sellXRP_BX_fee) - (fundAmountHB * 31.22)) / (fundAmountHB * 31.22)) * 100 ).toFixed(2);           
...
//                   ((((((fundAmountHB/buyLTC_HB_fee)- feeWD_LTC_HB ) * sellLTC_BN_fee) - (fundAmountHB)) / (fundAmountHB)) * 100 ).toFixed(2);           
      ...
      document.getElementById("BN-CO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountBN/buyBTC_BN_fee)- feeWD_BTC_BN ) * sellBTC_CO_fee) - (fundAmountBN * 1070.18)) / (fundAmountBN * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BN-CO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountBN/buyETH_BN_fee)- feeWD_ETH_BN ) * sellETH_CO_fee) - (fundAmountBN * 1070.18)) / (fundAmountBN * 1070.18)) * 100 ).toFixed(2);           

/*      document.getElementById("BN-CO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountBN/buyXRP_BN_fee)- feeWD_XRP_BN ) * sellXRP_CO_fee) - (fundAmountBN * 1070.18)) / (fundAmountBN * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BN-CO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountBN/buyETC_BN_fee)- feeWD_ETC_BN ) * sellETC_CO_fee) - (fundAmountBN * 1070.18)) / (fundAmountBN * 1070.18)) * 100 ).toFixed(2);  
*/
      document.getElementById("BN-CO_LTC_oneWay").innerHTML= 

                  ((((((fundAmountBN/buyLTC_BN_fee)- feeWD_LTC_BN ) * sellLTC_CO_fee) - (fundAmountBN * 1070.18)) / (fundAmountBN * 1070.18)) * 100 ).toFixed(2);           
...
*/
      ...
      // //BN-BX                        
       ...
       document.getElementById("BN-BX_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountBN/buyBTC_BN_fee)- feeWD_BTC_BN ) * sellBTC_BX_fee) - (fundAmountBN * 31.22)) / (fundAmountBN * 31.22)) * 100 ).toFixed(2);           

       document.getElementById("BN-BX_ETH_oneWay").innerHTML= 

                   ((((((fundAmountBN/buyETH_BN_fee)- feeWD_ETH_BN ) * sellETH_BX_fee) - (fundAmountBN * 31.22)) / (fundAmountBN * 31.22)) * 100 ).toFixed(2); 

        document.getElementById("BN-BX_LTC_oneWay").innerHTML= 

                   ((((((fundAmountBN/buyLTC_BN_fee)- feeWD_LTC_BN ) * sellLTC_BX_fee) - (fundAmountBN * 31.22)) / (fundAmountBN * 31.22)) * 100 ).toFixed(2);             

/*       document.getElementById("BN-BX_XRP_oneWay").innerHTML= 

                   ((((((fundAmountBN/buyXRP_BN_fee)- feeWD_XRP_BN ) * sellXRP_BX_fee) - (fundAmountBN * 31.22)) / (fundAmountBN * 31.22)) * 100 ).toFixed(2);           
*/
      //BN-BF                       
...
//BN-KB
      ...
      document.getElementById("BN-KB_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountBN/buyBTC_BN_fee)- feeWD_BTC_BN ) * sellBTC_KB_fee) - (fundAmountBN * 1070.18)) / (fundAmountBN * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("BN-KB_ETH_oneWay").innerHTML= 

                  ((((((fundAmountBN/buyETH_BN_fee)- feeWD_ETH_BN ) * sellETH_KB_fee) - (fundAmountBN * 1070.18)) / (fundAmountBN * 1070.18)) * 100 ).toFixed(2);           
      ...
      document.getElementById("QN-CO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountQN/buyBTC_QN_fee)- feeWD_BTC_QN ) * sellBTC_CO_fee) - (fundAmountQN * 1070.18)) / (fundAmountQN * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("QN-CO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountQN/buyETH_QN_fee)- feeWD_ETH_QN ) * sellETH_CO_fee) - (fundAmountQN * 1070.18)) / (fundAmountQN * 1070.18)) * 100 ).toFixed(2);           
      ...
      document.getElementById("QN-PO_ETH_oneWay").innerHTML= 
       ...
       document.getElementById("QN-BX_BTC_oneWay").innerHTML= 
                 ...
                 ((((((fundAmountQN/buyBTC_QN_fee)- feeWD_BTC_QN ) * sellBTC_BX_fee) - (fundAmountQN * 31.22)) / (fundAmountQN * 31.22)) * 100 ).toFixed(2);           

      document.getElementById("QN-BX_ETH_oneWay").innerHTML= 

                   ((((((fundAmountQN/buyETH_QN_fee)- feeWD_ETH_QN ) * sellETH_BX_fee) - (fundAmountQN * 31.22)) / (fundAmountQN * 31.22)) * 100 ).toFixed(2);           
      ...
      document.getElementById("QN-KB_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountQN/buyBTC_QN_fee)- feeWD_BTC_QN ) * sellBTC_KB_fee) - (fundAmountQN * 1070.18)) / (fundAmountQN * 1070.18)) * 100 ).toFixed(2);           

      document.getElementById("QN-KB_ETH_oneWay").innerHTML= 

                  ((((((fundAmountQN/buyETH_QN_fee)- feeWD_ETH_QN ) * sellETH_KB_fee) - (fundAmountQN * 1070.18)) / (fundAmountQN * 1070.18)) * 100 ).toFixed(2);           

//  //KB-KK                        

      document.getElementById("KB-KK_BTC_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyBTC_KB_fee)- feeWD_BTC_KB ) * sellBTC_KK_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-KK_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETH_KB_fee)- feeWD_ETH_KB ) * sellETH_KK_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-KK_XRP_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyXRP_KB_fee)- feeWD_XRP_KB ) * sellXRP_KK_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-KK_ETC_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETC_KB_fee)- feeWD_ETC_KB ) * sellETC_KK_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           
      ...
      document.getElementById("KB-PO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountKB/buyBTC_KB_fee)- feeWD_BTC_KB ) * sellBTC_PO_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-PO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETH_KB_fee)- feeWD_ETH_KB ) * sellETH_PO_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-PO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyXRP_KB_fee)- feeWD_XRP_KB ) * sellXRP_PO_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-PO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETC_KB_fee)- feeWD_ETC_KB ) * sellETC_PO_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);     
      ...
      // //KB-BX                       
       ...
       document.getElementById("KB-BX_BTC_oneWay").innerHTML= 
                   ...
                   ((((((fundAmountKB/buyBTC_KB_fee)- feeWD_BTC_KB ) * sellBTC_BX_fee) - (fundAmountKB / 33.75 )) / (fundAmountKB / 33.75 )) * 100 ).toFixed(2);           

       document.getElementById("KB-BX_ETH_oneWay").innerHTML= 

                   ((((((fundAmountKB/buyETH_KB_fee)- feeWD_ETH_KB ) * sellETH_BX_fee) - (fundAmountKB / 33.75 )) / (fundAmountKB / 33.75 )) * 100 ).toFixed(2);           

      document.getElementById("KB-BX_XRP_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyXRP_KB_fee)- feeWD_XRP_KB ) * sellXRP_BX_fee) - (fundAmountKB / 33.75 )) / (fundAmountKB / 33.75 )) * 100 ).toFixed(2);  
      ...
      document.getElementById("KB-BF_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountKB/buyBTC_KB_fee)- feeWD_BTC_KB ) * sellBTC_BF_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-BF_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETH_KB_fee)- feeWD_ETH_KB ) * sellETH_BF_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-BF_XRP_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyXRP_KB_fee)- feeWD_XRP_KB ) * sellXRP_BF_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-BF_ETC_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETC_KB_fee)- feeWD_ETC_KB ) * sellETC_BF_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);   

      //  //KB-BT                        

      document.getElementById("KB-BT_BTC_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyBTC_KB_fee)- feeWD_BTC_KB ) * sellBTC_BT_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-BT_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETH_KB_fee)- feeWD_ETH_KB ) * sellETH_BT_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-BT_XRP_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyXRP_KB_fee)- feeWD_XRP_KB ) * sellXRP_BT_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-BT_ETC_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETC_KB_fee)- feeWD_ETC_KB ) * sellETC_BT_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2); 
      ...
      document.getElementById("KB-BS_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountKB/buyBTC_KB_fee)- feeWD_BTC_KB ) * sellBTC_BS_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-BS_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETH_KB_fee)- feeWD_ETH_KB ) * sellETH_BS_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-BS_XRP_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyXRP_KB_fee)- feeWD_XRP_KB ) * sellXRP_BS_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);       
      ...
      //             ((((((fundAmountKB/buyBTC_KB_fee)- feeWD_BTC_KB ) * sellBTC_HB_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("KB-HB_ETH_oneWay").innerHTML= 

      //             ((((((fundAmountKB/buyETH_KB_fee)- feeWD_ETH_KB ) * sellETH_HB_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("KB-HB_XRP_oneWay").innerHTML= 

      //             ((((((fundAmountKB/buyXRP_KB_fee)- feeWD_XRP_KB ) * sellXRP_HB_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("KB-HB_ETC_oneWay").innerHTML= 

      //             ((((((fundAmountKB/buyETC_KB_fee)- feeWD_ETC_KB ) * sellETC_HB_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);       

      // document.getElementById("KB-HB_LTC_oneWay").innerHTML= 

      //             ((((((fundAmountKB/buyLTC_KB_fee)- feeWD_LTC_KB ) * sellLTC_HB_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

        //KB-BN                        

      document.getElementById("KB-BN_BTC_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyBTC_KB_fee)- feeWD_BTC_KB ) * sellBTC_BN_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-BN_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETH_KB_fee)- feeWD_ETH_KB ) * sellETH_BN_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("KB-BN_XRP_oneWay").innerHTML= 

      //             ((((((fundAmountKB/buyXRP_KB_fee)- feeWD_XRP_KB ) * sellXRP_BN_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      // document.getElementById("KB-BN_ETC_oneWay").innerHTML= 

      //             ((((((fundAmountKB/buyETC_KB_fee)- feeWD_ETC_KB ) * sellETC_BN_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);       
 ...
 //KB-QN                        
      ...
      document.getElementById("KB-QN_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountKB/buyBTC_KB_fee)- feeWD_BTC_KB ) * sellBTC_QN_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           

      document.getElementById("KB-QN_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKB/buyETH_KB_fee)- feeWD_ETH_KB ) * sellETH_QN_fee) - (fundAmountKB * 0.00093442224)) / (fundAmountKB * 0.00093442224)) * 100 ).toFixed(2);           
